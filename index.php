...
<head>
	...
	<link rel="icon" href="https://blog.remontti.com.br/wp-content/uploads/2020/04/cropped-Tux-icon-32x32.png" sizes="32x32" />
	<link rel="icon" href="https://blog.remontti.com.br/wp-content/uploads/2020/04/cropped-Tux-icon-192x192.png" sizes="192x192" />
	<link rel="apple-touch-icon" href="https://blog.remontti.com.br/wp-content/uploads/2020/04/cropped-Tux-icon-180x180.png" />
	<meta name="msapplication-TileImage" content="https://blog.remontti.com.br/wp-content/uploads/2020/04/cropped-Tux-icon-270x270.png" />
</head>
<body>
	<?php 
		if (empty($_POST['c'])) { 
		...
		<form method="POST" name="formulario">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="c"><b>IP inicial invÃ¡lido</b></label>
					<input type="text" class="form-control" id="c" name="c" placeholder="ex: 100.64.0.0">
				</div>
				<div class="form-group col-md-6">
                                        <label for="s"><b>Bloco PÃºblico</b></label>
                                        <input type="text" class="form-control" id="s" name="s" placeholder="ex: 200.200.200.0/26">
                                </div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-4">
                                        <label for="t"><b>1 pÃºblico para quantos invÃ¡lidos?</b></label>
                                        <select class="custom-select" name="t" id="t">
                                        <option value="2">2 (~32000 portas por IP PÃºblico)</option>
                                        <option value="4">4 (~16000 portas por IP PÃºblico)</option>
                                        <option value="8">8 (~8000 portas por IP PÃºblico)</option>
                                        <option value="16">16 (~4000 portas por IP PÃºblico)</option>
                                        <option value="32">32 (~2000 portas por IP PÃºblico)</option>
                                        <option value="64" selected="">64 (~1000 portas por IP PÃºblico)</option>
                                        <option value="128">128 (~500 portas por IP PÃºblico) NÃ£o recomendado</option>
                                        </select>
					<small id="obs" class="form-text text-muted">NÂº de clientes para cada X nÂº de portas sobre 1 Ãºnico IP pÃºblico </small>
                                </div>
				<div class="form-group col-md-4">
					<label for="intpub"><b>Nome da interface para adicionar os IPs PÃºblicos</b></label>
					<input type="text" class="form-control" id="intpub" name="intpub" placeholder="ex: sfp-sfpplus1">
					<small id="obs" class="form-text text-muted">Bloco pÃºblico serÃ¡ quebrado em /32 e adicionar a uma interface.</small>
				</div>
				<div class="form-group col-md-4">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<select class="custom-select" name="int" id="int" onChange="dis_able()">
						<option value="null">NÃ£o Informar</option>
						<option value="nome">Nome da Interface</option>
						<option value="list">Interface List</option>				
					</select>
					<small id="obs" class="form-text text-muted">Se optar por int. list nÃ£o esqueÃ§a de adicionar sua uplink a ela.</small>
				</div>	
				<div class="form-group col-md-6">
			...
			<div class="form-group">		    
				...
				<small id="obs" class="form-text text-muted">Algumas pessoas jÃ¡ alegaram ter algum problema fazendo para UDP.</small>
			</div>
			<hr>
			<div class="form-group">
	...
	<?php
			...
			if(!filter_var($_POST['c'], FILTER_VALIDATE_IP, FILTER_FLAG_IPV4)) {
			  echo "IP inicial invÃ¡lido.". $_POST['c']; die;
			}

			if(!filter_var($get_ip_mask[0], FILTER_VALIDATE_IP, FILTER_FLAG_IPV4)) {
			  echo "Bloco pÃºblico invÃ¡lido.".$get_ip_mask[0]; die;
			}
			if($get_ip_mask[1] == '31') { 
				echo "MÃ¡scara nÃ£o suportada."; die;
			}
			...
			elseif ($_POST['int'] == "nome") {
				...
				echo "# NÃ£o esqueÃ§a de adicionar sua interface de Uplink ao grupo ".$_POST['nome']." <br />";
	...
	?>
	<div align="center">
		<a href="https://blog.remontti.com.br/doar">Fazer uma DoaÃ§Ã£o</a> | <a href="https://github.com/remontti/php-cgnat-netmap-routeros">CÃ³digo Fonte</a>
